...
if __name__ == '__main__':
    ...
    for i in range(N):
        ...
        # getattr(my_list, method)((value[0])(value[1]))if method == "insert" else getattr(my_list, method)(value)
        
        print(my_list) if method == 'print' else getattr(my_list, method)(*value)
